...
urlpatterns = [
    ...
    path('questions', views.all_questions, name='ask_zinovyev_app/questions'),
    re_path(r'^questions/(?P<page>[0-9]{7})/$', views.all_questions, name='ask_zinovyev_app/questions'),
